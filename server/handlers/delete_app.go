...
// DeleteApp handles DELETE /apps/{app_id}
func (a *Api) DeleteApp(c echo.Context, appId string) error {
	return a.deleteAppByID(c, "DeleteApp", appId)
}

func (a *Api) deleteAppByID(c echo.Context, handlerName, appId string) error {

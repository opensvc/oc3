...
// PostTagsNodes handles POST /tags/nodes
func (a *Api) PostTagsNodes(c echo.Context) error {
	log := echolog.GetLogHandler(c, "PostTagsNodes")
	ctx, cancel := context.WithTimeout(c.Request().Context(), a.SyncTimeout)
	defer cancel()

	var body server.PostTagsNodesJSONRequestBody
	...
	return a.attachTagNode(c, log, ctx, tag, body.NodeId, body.TagAttachData)
}

...
// DeleteTagsServices handles DELETE /tags/services
func (a *Api) DeleteTagsServices(c echo.Context) error {
	log := echolog.GetLogHandler(c, "DeleteTagsServices")
	ctx, cancel := context.WithTimeout(c.Request().Context(), a.SyncTimeout)
	defer cancel()

	var body server.DeleteTagsServicesJSONRequestBody
	...
	return a.detachTagService(c, log, ctx, tag, body.SvcId)
}

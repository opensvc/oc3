...
// GetServiceNodeResources handles GET /services/{svc_id}/nodes/{node_id}/resources
func (a *Api) GetServiceNodeResources(c echo.Context, svcId string, nodeId string, params server.GetServiceNodeResourcesParams) error {
	log := echolog.GetLogHandler(c, "GetServiceNodeResources")
	...
	return a.handleList(c, "GetServiceNodeResources", "resource", listEndpointParams{
		props: params.Props, limit: params.Limit, offset: params.Offset,
		meta: params.Meta, stats: params.Stats, orderby: params.Orderby, groupby: params.Groupby,
	}, func(ctx context.Context, p cdb.ListParams) ([]map[string]any, error) {
		return a.ODB.GetServiceNodeResources(ctx, svc.SvcID, node.NodeID, p)
	})
}

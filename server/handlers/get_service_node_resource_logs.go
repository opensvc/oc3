...
// GetServiceNodeResourceLogs handles GET /services/{svc_id}/nodes/{node_id}/resources/logs
func (a *Api) GetServiceNodeResourceLogs(c echo.Context, svcId string, nodeId string, params server.GetServiceNodeResourceLogsParams) error {
	log := echolog.GetLogHandler(c, "GetServiceNodeResourceLogs")
	...
	return a.handleList(c, "GetServiceNodeResourceLogs", "resource_log", listEndpointParams{
		props: params.Props, limit: params.Limit, offset: params.Offset,
		meta: params.Meta, stats: params.Stats, orderby: params.Orderby, groupby: params.Groupby,
	}, func(ctx context.Context, p cdb.ListParams) ([]map[string]any, error) {
		return a.ODB.GetServiceNodeResourceLogs(ctx, svc.SvcID, node.NodeID, p)
	})
}

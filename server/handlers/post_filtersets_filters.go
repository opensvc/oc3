...
// PostFiltersetsFilters handles POST /filtersets_filters
func (a *Api) PostFiltersetsFilters(c echo.Context) error {
	log := echolog.GetLogHandler(c, "PostFiltersetsFilters")
	...
	var body server.PostFiltersetsFiltersJSONRequestBody

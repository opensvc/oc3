...
// GetServiceNode handles GET /services/{svc_id}/nodes/{node_id}
func (a *Api) GetServiceNode(c echo.Context, svcId string, nodeId string, params server.GetServiceNodeParams) error {
	log := echolog.GetLogHandler(c, "GetServiceNode")
	...
	return a.handleItem(c, "GetServiceNode", "instance", "svc_id", svc.SvcID, listEndpointParams{
